...
public class WordUtil {
	...
	public static String make4characters() {
		List<String> syllable = Arrays.asList("김", "이", "박", "최", "정", "강", "조", "윤", "장", "임", "한", "오", "서", "신",
				...
				"구", "용", "가", "강", "건", "경", "고", "관", "광", "구", "규", "근", "기", "길", "나", "남", "노",
				...
				"롱", "평", "늘", "늬", "랑", "얀", "향", "울", "련");
		Collections.shuffle(syllable);
		return syllable.get(0) + syllable.get(1) + syllable.get(2) + syllable.get(3);
